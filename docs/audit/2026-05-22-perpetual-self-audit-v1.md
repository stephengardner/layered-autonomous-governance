...
Multiple shipped artifacts reference `docs/audit/2026-05-22-perpetual-self-audit-v0.md` as their motivating audit doc but that file does not exist in the repo. V0 was the OUTPUT of the self-audit driver (a 6-PR backlog), not a checked-in markdown. The on-disk citations live in [docs/runbooks/README.md:11](../runbooks/README.md), [docs/runbooks/README.md:38](../runbooks/README.md), [docs/runbooks/reaper-not-running.md:39](../runbooks/reaper-not-running.md), [docs/runbooks/bot-token-expired.md:46](../runbooks/bot-token-expired.md), and [docs/runbooks/cr-silent-skip.md:44](../runbooks/cr-silent-skip.md) (5 broken refs across 4 files). This is itself a finding: runbook citations to a sibling audit doc must resolve, or the operator pattern-matching from runbook to audit to code breaks. This v1 doc establishes the audit-doc convention going forward; v0's projection can be back-filled in a follow-up from the PR metadata that already references it (PRs #437, #439, #440, #441, #442, #443, #444 plus #434, #436, #438).
