...
export interface ResolvedSession {
   ...
   * cache before the underlying adapter resumes). Wrapper calls this
   * after the strategy resolves and before the adapter spawn. Failures
   * throw and are surfaced to the caller.
   */
