...
import { Book, GitBranch, Activity, Users, Network, LineChart, Workflow, Gauge, Lightbulb, ShieldAlert, Radio, GitFork, Brain, Zap, MoreHorizontal, GitMerge, RotateCcw, ClipboardList, Target, HeartPulse } from 'lucide-react';
...
const items: ReadonlyArray<NavItem> = [
  ...
  { id: 'system-health', label: 'System Health', mobileLabel: 'Health', icon: HeartPulse },
  ...
  { id: 'operator-actions', label: 'Audit', icon: ClipboardList },
];
